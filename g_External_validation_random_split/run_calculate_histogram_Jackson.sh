...
python run_calculate_histogram_Jackson.py --iteration 1 --k 100 --method centroid &&
python run_calculate_histogram_Jackson.py --iteration 2 --k 100 --method centroid &&
python run_calculate_histogram_Jackson.py --iteration 3 --k 100 --method centroid &&
python run_calculate_histogram_Jackson.py --iteration 4 --k 100 --method centroid &&
python run_calculate_histogram_Jackson.py --iteration 5 --k 100 