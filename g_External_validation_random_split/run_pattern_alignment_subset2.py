...
INPUT_Query = os.path.join(
    PROJECT_ROOT, "Output", "a_Cellular_graph_random_split", "Danenberg", "Subset_2"
)
...
print(
    f"Concatenated feature shape in Subset 1 {X_Reference.shape} from {len(FILE_NAMES_Reference)} cellular graphs",
...
print(
    f"Concatenated feature shape in Subset 2 {X_Query.shape} from {len(FILE_NAMES_Query)} cellular graphs"
)
# ----------------------------------------------------------------------------------------
# Normalize the data
